...
package com.bernardomg.security.adapter.inbound.jpa.repository.test.config.pagination;
...
public abstract class AbstractPaginationIT<T> {
    ...
    protected abstract Page<T> read(final Pagination pagination);
