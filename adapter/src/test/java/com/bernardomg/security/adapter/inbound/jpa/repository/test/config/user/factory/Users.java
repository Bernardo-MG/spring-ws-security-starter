...
package com.bernardomg.security.adapter.inbound.jpa.repository.test.config.user.factory;
...
public final class Users {
    ...
    public static final User upperCase() {
        return new User(UserConstants.EMAIL.toUpperCase(LocaleContextHolder.getLocale()),
            ...
            UserConstants.NAME.toUpperCase(LocaleContextHolder.getLocale()), true, true, true, false, List.of(), List.of());
    }
