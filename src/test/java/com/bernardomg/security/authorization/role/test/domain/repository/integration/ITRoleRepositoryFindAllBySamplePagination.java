...
@IntegrationTest
@DisplayName("RoleRepository - find all by sample - pagination")
@SingleRole
class ITRoleRepositoryFindAllBySamplePagination {

    @Autowired
    private RoleRepository repository;

    public ITRoleRepositoryFindAllBySamplePagination() {
        super();
    }
