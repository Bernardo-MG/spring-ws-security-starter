...
@Sql({ "/db/queries/security/resource/single.sql", "/db/queries/security/resource/alternative.sql",
        ...
        "/db/queries/security/relationship/role_permissions_crud_granted.sql",
        "/db/queries/security/relationship/role_alternative_permissions_other_crud_granted.sql",
