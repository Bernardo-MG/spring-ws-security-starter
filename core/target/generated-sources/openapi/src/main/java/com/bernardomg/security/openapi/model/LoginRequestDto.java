...
public class LoginRequestDto {
   ...
   */
  @NotNull 
  @Schema(name = "username", description = "Unique username of the account.", requiredMode = Schema.RequiredMode.REQUIRED)
   ...
   */
  @NotNull 
  @Schema(name = "password", description = "Account password.", requiredMode = Schema.RequiredMode.REQUIRED)
